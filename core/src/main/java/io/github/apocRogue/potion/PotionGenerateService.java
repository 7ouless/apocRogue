...
import io.github.apocRogue.shop.ShopPotionPayload;

public class PotionGenerateService {

    public interface Callback {
        void onSuccess(ShopPotionPayload p);
    ...
    public void generate(String idPrefix, int level, int sub, Callback cb) {
        ...
        req.setUrl("https://api.yourgame.com/potion/generate");
        req.setContent(body);
        ...
        Gdx.net.sendHttpRequest(req, new HttpResponseListener() {
            @Override public void handleHttpResponse(HttpResponse http) {
                try {
                    ShopPotionPayload p = json.fromJson(ShopPotionPayload.class,
