...
public class TraderA extends ShopKeeper {
    ...
    private static List<ShopItem> createInventory() {
        ...
        items.add(new ShopItem("Potion", "Ah! A potion, I believe this one cures your wounds. I'll let you have it for 100 gold.", 100));
        items.add(new ShopItem("Random Brew", "I unfortunately lost the label on this one. Whoopsie! I'll let you have it for 50 gold.", 50));
    ...
    public String getGreeting() {
        return "Trader A: Hello, dear friend. Looking for potions or maybe something... rarer?";
    }

    @Override
    public String getThankYouLine() {
        return "Trader A: Much appreciated! Would you like another?";
    }

    @Override
    public String getCannotAffordLine() {
        return "Trader A: Sorry, but you don't have the gold for that.";
    }

    @Override
    public String getLockedItemLine() {
        return "Trader A: Shhh, you haven't earned my trust enough to see that.";
    }
}
